...
<html>
<head>
<title>Launch Page: Wooffin Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="wooffinForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Wooffin, Level 1</option>
				<option value="02">Wooffin, Level 2</option>
				<option value="03">Wooffin, Level 3</option>
				<option value="04">Wooffin, Level 4</option>
				<option value="05">Wooffin, Level 5</option>
				<option value="06">Wooffin, Level 6</option>
				<option value="07">Wooffin, Level 7</option>
				<option value="08">Wooffin, Level 8</option>
				<option value="09">Wooffin, Level 9</option>
				<option value="10">Wooffin, Level 10</option>
			  </select>
        ...
        {
            $("#wooffinForm").attr('action', "wooffin/wooffin"+ $("#level").val() +  ".php");
        });
